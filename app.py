...
PLOTLY_LAYOUT = dict(
    ...
    font=dict(family="DM Sans", color="#6b87b4", size=12),
    xaxis=dict(gridcolor="#1e3056", zerolinecolor="#1e3056"),
    yaxis=dict(gridcolor="#1e3056", zerolinecolor="#1e3056"),
    margin=dict(l=20, r=20, t=40, b=20),
    hoverlabel=dict(bgcolor="#111d34", bordercolor="#1e3056", font_color="#e8f0fe"),
)
...
with st.sidebar:
    ...
    <div style='text-align:center; padding: 1.2rem 0 0.5rem 0;'>
        ...
        <div style='font-size:0.75rem; color:#6b87b4; margin-top:0.2rem;'>Child Malnutrition Detector</div>
    </div>
    <hr style='border-color:#1e3056; margin: 1rem 0;'>
    """, unsafe_allow_html=True)
    ...
    st.markdown("<hr style='border-color:#1e3056; margin: 1rem 0;'>", unsafe_allow_html=True)
    st.markdown("""
    <div style='font-size:0.8rem; color:#6b87b4; line-height:1.7;'>
    <b style='color:#e8f0fe;'>Features</b><br>
    ...
    st.markdown("<hr style='border-color:#1e3056; margin: 1rem 0;'>", unsafe_allow_html=True)
    st.markdown("""
    <div style='font-size:0.75rem; color:#6b87b4; text-align:center;'>
    Based on <a href='https://www.who.int/tools/child-growth-standards' style='color:#00d4ff;'>WHO Child Growth Standards</a>
    </div>
    """, unsafe_allow_html=True)
...
if "Single" in mode:
    ...
    if predict_btn:
        ...
        <div class='result-box {css_class}'>
            ...
            <br>
            <div class='info-pill' style='background:rgba(255,255,255,0.04); border-color: rgba(255,255,255,0.1); color:#e8f0fe;'>
        ...
        with r2:
            ...
            for i, action in enumerate(recs["actions"], 1):
                ...
                <div style='display:flex; gap:0.6rem; align-items:flex-start; margin-bottom:0.6rem;'>
                  ...
                  <span style='font-size:0.88rem; color:#c8d8f0; line-height:1.5;'>{action}</span>
                </div>
                """, unsafe_allow_html=True)
...
# ═══════════════════════════════════════════════
    ...
    st.markdown("""
    <div style='background:var(--card); border:1px solid var(--border); border-radius:12px; padding:1.2rem 1.5rem; margin-bottom:1.2rem; font-size:0.88rem; color:#6b87b4;'>
    <b style='color:#e8f0fe;'>Required columns (case-insensitive):</b><br>
    <code style='color:#00d4ff;'>AGE</code> (months) &nbsp;·&nbsp;
    <code style='color:#00d4ff;'>WEIGHT</code> (kg) &nbsp;·&nbsp;
    <code style='color:#00d4ff;'>HEIGHT</code> (cm) &nbsp;·&nbsp;
    <code style='color:#00d4ff;'>MUAC</code> (cm)<br><br>
            ...
            fig_pie.update_layout(
                **PLOTLY_LAYOUT, height=320,
                ...
                annotations=[dict(text=f"<b>{total}</b><br>children", x=0.5, y=0.5,
                                  font_size=14, font_color="#e8f0fe", showarrow=False)]
            )
...
with st.expander("📖 About this tool & WHO Reference Standards"):
    st.markdown("""
    <div style='font-size:0.9rem; color:#6b87b4; line-height:1.8;'>
    <b style='color:#e8f0fe; font-family:Syne,sans-serif;'>NutriScan AI</b> uses a 
    <b style='color:#00d4ff;'>Gaussian Mixture Model (GMM)</b> trained on WHO synthetic reference 
    ...
    <div style='font-size:0.82rem; color:#6b87b4;'>
